  ...
  <div id="nhsl-nhsl">
    <div class="form-wrapper clinic-search-wrap">
        ...
        <form action="./" method="GET" class="form" role="form">
                ...
                </div><!--col-sm-3 clinic-search-type-->
          </form>
              ...
              <div class="col-sm-3 clinic-search-type">
                <label for="">Search by Day</label>
                    <div class="form-group">
                        ...
                        <option value='0'>Daily</option><option value='1'>Sunday</option><option value='2'>Monday</option><option value='3'>Tuesday</option><option value='4'>Wednesday</option><option value='5'>Thursday</option><option value='6'>Friday</option><option value='7'>Saturday</option>
                        </select>
                    </div><!--form-group-->
    ...
    </div><!--form-wrapper clinic-search-wrap-->
  </div><!--nhsl-nhsl-->
