          ...
          <div class="col-lg-12">
            ...
            <div class="col-sm-6" id="slider-thumbs">
                <!-- Bottom switcher of slider -->
                    ...
                    <div class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-2"><img src="../images/3.jpg" alt="1">
                        </a>
                    </div><!--col-sm-3-->

                    <div class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-3"><img src="../images/4.jpeg" alt="1">
                        </a>
                    </div><!--col-sm-3-->

                    <div class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-4"><img src="../images/5.jpg" alt="1">
                        </a>
                    </div><!--col-sm-3-->

                    <div class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-5"><img src="../images/6.jpg" alt="1">
                        </a>
                    </div><!--col-sm-3-->

                    <div class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-6"><img src="../images/7.jpeg" alt="1">
                        </a>
                    </div><!--col-sm-3-->

                    <div class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-7"><img src="../images/8.jpg" alt="1">
                        </a>
                    </div><!--col-sm-3-->

                    <div class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-8"><img src="../images/9.jpeg" alt="1">
                        </a>
                    </div><!--col-sm-3-->

                    <div class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-9"><img src="../images/10.jpeg" alt="1">
                        </a>
                    </div><!--col-sm-3-->

                    <div class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-10"><img src="../images/11.jpeg" alt="1">
                        </a>
                    </div><!--col-sm-3-->

                    <div class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-11"><img src="../images/12.jpeg" alt="1">
                        </a>
                    </div><!--col-sm-3-->
