...
<br>
    ...
    <form name="doclog" action="<?php echo $_SERVER['PHP_SELF']?>"  method="post">
        <div class="container">
            <center><h1 style="color:#242424;">Pharmacist Registration</h1></center>
        </div>
        <br>
        <br>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="number" class="form-control form-control-sm" name="contactno" id="contactno" min="1" step="1" max="9999999999" placeholder="Enter Telephone Number" required autofocus>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="pharmaid" class="col-sm-4 col-form-label"><h5>Pharmacist ID</h5></label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control form-control-sm" name="pharmaid" id="pharmaid" placeholder="Enter Pharmacist ID" autocomplete="off" required autofocus>
                        </div>
                    </div> 
                </div>
            </div>
...
<?php
    if (null !==(filter_input(INPUT_POST, 'submit'))){
        ...
        $pharmaid = filter_input(INPUT_POST,'pharmaid');
        $email = filter_input(INPUT_POST,'email');
        $password = rand(999, 99999);
        $hashed_password = password_hash($password, PASSWORD_DEFAULT);
        $flag = "3";
        
        $sql .= "INSERT INTO user (userid,password,flag) VALUES ('$pharmaid','$hashed_password','$flag');";
        $sql .= "INSERT INTO pharmacist (name,contactno,pharmaid,email) VALUES ('$name','$contactno','$pharmaid','$email');";
