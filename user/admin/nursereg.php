...
<br>
    ...
    <form name="doclog" action="<?php echo $_SERVER['PHP_SELF']?>"  method="post">
        <div class="container">
            <center><h1 style="color:#242424;">Nurse Registration</h1></center>
        </div>
        <br>
        <br>
...
<?php
    if (null !==(filter_input(INPUT_POST, 'submit'))){
        ...
        $sql .= "INSERT INTO user (userid,password,flag) VALUES ('$nurseid','$hashed_password','$flag');";
        $sql .= "INSERT INTO nurse (name,contactno,nurseid,email) VALUES ('$name','$contactno','$nurseid','$email');";
