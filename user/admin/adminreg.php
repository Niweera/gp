...
<br>
    ...
    <form name="doclog" action="<?php echo $_SERVER['PHP_SELF']?>"  method="post">
        <div class="container">
            <center><h1 style="color:#242424;">Administrator Registration</h1></center>
        </div>
        <br>
        <br>
        <div class="container border pt-4 bg-light rounded">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group row">
                        <label for="adminid" class="col-sm-4 col-form-label"><h5>Admin ID</h5></label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control form-control-sm" name="adminid" id="adminid" placeholder="Enter Admin ID" required autofocus autocomplete="off">
                        </div>
                    </div> 
                </div>
            </div>
