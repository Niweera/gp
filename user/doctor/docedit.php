...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #0097a7;box-shadow: 0px 0px 12px #828282;"><!--change-->
    ...
    <div class="navbar-collapse collapse w-100 order-3 dual-collapse2" id="navbarSupportedContent">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item active" href="./docedit.php">Edit Profile</a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group row">
                        <label for="name" class="col-sm-4 col-form-label"><h5>SLMC ID</h5></label>
                        <div class="col-lg-3">
                            <input type="text" class="form-control form-control-sm" name="slmcid" id="slmcid" value="<?php echo $_SESSION['userid'];?>" autocomplete="off" required disabled>
                        </div>
                    </div>
                    <div class="form-group row">
...
<?php
    if (null !==(filter_input(INPUT_POST, 'submit'))){
        ...
        if (!$mysqli_query){
                    ...
                    echo "<script>alert(\"Successfully Updated!\");window.location.href = './docedit.php';</script>";
