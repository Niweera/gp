...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #0097a7;box-shadow: 0px 0px 12px #828282;"><!--change-->
    ...
    <div class="navbar-collapse collapse w-100 order-3 dual-collapse2" id="navbarSupportedContent">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item active" href="./nursedit.php">Edit Profile</a>
            </div>
        </li>
        <li class="nav-item">
...
<br>
    ...
    <form name="doclog" action="<?php echo $_SERVER['PHP_SELF']?>"  method="post">
        <div class="container">
            <center><h1 style="color:#242424;">Edit Nurse Profile</h1></center>
        </div>
        <br>
        <br>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group row">
                        <label for="name" class="col-sm-4 col-form-label"><h5>Nurse ID</h5></label>
                        <div class="col-lg-3">
                            <input type="text" class="form-control form-control-sm" name="nurseid" id="nurseid" value="<?php echo $_SESSION['userid'];?>" autocomplete="off" required disabled>
                        </div>
                    </div>
                    <div class="form-group row">
...
<?php
    if (null !==(filter_input(INPUT_POST, 'submit'))){
        ...
        $sql .= "UPDATE nurse SET name='$name',email='$email',contactno='$contactno' WHERE nurseid='$userid';";
        ...
        if (!$mysqli_query){
                    ...
                    echo "<script>alert(\"Successfully Updated!\");window.location.href = './nursedit.php';</script>";
