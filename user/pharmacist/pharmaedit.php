...
<?php
    if (null !==(filter_input(INPUT_POST, 'submit'))){
        ...
        $sql .= "UPDATE pharmacist SET name='$name',email='$email',contactno='$contactno' WHERE pharmaid='$userid';";
        ...
        if (!$mysqli_query){
                    ...
                    echo "<script>alert(\"Successfully Updated! Redirecting to homepage.\");window.location.href = './index.php';</script>";
