...
<div class="container">
    <div class="row">
        ...
        </div><!--col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12-->
        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
            ...
            </div><!--container border pb-3-->
        </div><!--col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12-->
    </div><!--row-->
</div><!--container-->
<br>
<br>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="./pharmaedit.php" class="btn btn-info btn-block">Go</a>
                                </div><!--card-body-->
                            </div><!--card-->
                        </div><!--col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12-->
                        <br>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="./view_reports.php" class="btn btn-info btn-block">View</a>
                                </div><!--card-body-->
                            </div><!--card-->
                        </div><!--col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12-->
                    </div><!--row-->
